...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/am/ActivityStack$MyBroadcastReceive;,
...
.field static final SHOW_ACTIVITY_RESUME_TIME:Z = true
...
.field private mMotLogSleepingHistory:I
...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Landroid/content/Context;Z)V
    ...
    .line 434
    iput-boolean v4, p0, Lcom/android/server/am/ActivityStack;->mStkReqIdleStatus:Z

    .line 435
    iput-object v2, p0, Lcom/android/server/am/ActivityStack;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;
...
.method private dispatchScreenStatusLocked(Landroid/content/Intent;)V
    .locals 5
    .parameter "newIntent"

    .prologue
    .line 449
    iget-boolean v3, p0, Lcom/android/server/am/ActivityStack;->mStkReqIdleStatus:Z
    ...
    iput-boolean v3, p0, Lcom/android/server/am/ActivityStack;->mStkReqIdleStatus:Z
...
.method private final relaunchActivityLocked(Lcom/android/server/am/ActivityRecord;IZ)Z
    ...
    const-string v2, "Switch is restarting resumed "
...
.method private final startActivityLocked(Lcom/android/server/am/ActivityRecord;ZZZ)V
    ...
    invoke-static {v3, v5, v6, v0}, Lcom/motorola/rdc/RdcUtils;->submitRdcMetric_UI13_UI15(Landroid/content/Context;Ljava/lang/String;ZI)V

    .line 1930
    .end local v18           #exitStatus:I
    :cond_d
    move-object/from16 v0, p0
...
.method private final startPausingLocked(ZZ)V
    ...
    iput-object v2, v8, Lcom/android/server/am/ActivityRecord;->state:Lcom/android/server/am/ActivityStack$ActivityState;

    .line 989
    iget-object v2, v8, Lcom/android/server/am/ActivityRecord;->task:Lcom/android/server/am/TaskRecord;
    ...
    invoke-virtual {v8, v2, v9}, Lcom/android/server/am/ActivityRecord;->updateThumbnail(Landroid/graphics/Bitmap;Ljava/lang/CharSequence;)V
    ...
    .line 999
    :try_start_0
    iget v2, p0, Lcom/android/server/am/ActivityStack;->mMotLogSleepingHistory:I
    ...
    iput v0, p0, Lcom/android/server/am/ActivityStack;->mMotLogSleepingHistory:I
    ...
    iget v3, p0, Lcom/android/server/am/ActivityStack;->mMotLogSleepingHistory:I
    ...
    iget v0, p0, Lcom/android/server/am/ActivityStack;->mMotLogSleepingHistory:I
...
.method final destroyActivityLocked(Lcom/android/server/am/ActivityRecord;ZZLjava/lang/String;)Z
    ...
    const-string v9, "Removing activity: token="
    ...
    .line 3966
    .local v5, removedFromHistory:Z
    const/4 v7, 0x0

    const/4 v8, 0x0

    invoke-virtual {p0, p1, v7, v8}, Lcom/android/server/am/ActivityStack;->cleanUpActivityLocked(Lcom/android/server/am/ActivityRecord;ZZ)V
    ...
    iget-object v7, v7, Lcom/android/server/am/ActivityManagerService;->mFocusedAppName:Ljava/lang/String;
    ...
    iget-boolean v7, v7, Lcom/android/server/am/ProcessRecord;->crashing:Z
    ...
    invoke-static {v7, v8, v9, v1}, Lcom/motorola/rdc/RdcUtils;->submitRdcMetric_UI13_UI15(Landroid/content/Context;Ljava/lang/String;ZI)V
    ...
    iput-object v8, v7, Lcom/android/server/am/ActivityManagerService;->mHeavyWeightProcess:Lcom/android/server/am/ProcessRecord;
    ...
    invoke-virtual {v7, v8, p3, v9}, Lcom/android/server/am/ActivityManagerService;->updateLruProcessLocked(Lcom/android/server/am/ProcessRecord;ZZ)V
    ...
    const-string v9, " being finished, but not in LRU list"
    ...
    .line 3957
    .end local v2           #hadApp:Z
    .end local v5           #removedFromHistory:Z
    :cond_a
    ...
    .line 3968
    .restart local v5       #removedFromHistory:Z
    :cond_b
    const/4 v2, 0x0
    ...
    .line 4014
    .restart local v2       #hadApp:Z
    .restart local v6       #skipDestroy:Z
    :catch_0
    move-exception v0
...
.method final moveTaskToBackLocked(ILcom/android/server/am/ActivityRecord;)Z
    ...
    invoke-virtual {v9}, Lcom/android/server/am/ActivityManagerService;->checkScreenIdle()V
...
.method final moveTaskToFrontLocked(Lcom/android/server/am/TaskRecord;Lcom/android/server/am/ActivityRecord;)V
    ...
    invoke-virtual {v5, v6, v8}, Lcom/android/server/wm/WindowManagerService;->prepareAppTransition(IZ)V
...
.method final resumeTopActivityLocked(Lcom/android/server/am/ActivityRecord;)Z
    ...
    iget-object v2, v0, Lcom/android/server/am/ActivityStack;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;

    if-nez v2, :cond_1

    .line 1437
    new-instance v2, Lcom/android/server/am/ActivityStack$MyBroadcastReceive;

    const/4 v3, 0x0

    move-object/from16 v0, p0

    invoke-direct {v2, v0, v3}, Lcom/android/server/am/ActivityStack$MyBroadcastReceive;-><init>(Lcom/android/server/am/ActivityStack;Lcom/android/server/am/ActivityStack$1;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/am/ActivityStack;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;

    .line 1438
    new-instance v21, Landroid/content/IntentFilter;

    const-string v2, "android.intent.action.stk.req_idle_screen_status"
    ...
    .line 1440
    .local v21, stkFilter:Landroid/content/IntentFilter;
    move-object/from16 v0, p0
    ...
    iget-object v3, v0, Lcom/android/server/am/ActivityStack;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;

    const/4 v4, 0x0

    move-object/from16 v0, p0

    iget-object v5, v0, Lcom/android/server/am/ActivityStack;->mHandler:Landroid/os/Handler;
    ...
    .line 1444
    .end local v21           #stkFilter:Landroid/content/IntentFilter;
    :cond_1
    if-nez v19, :cond_2
    ...
    iget v2, v0, Lcom/android/server/am/ActivityStack;->mMotLogSleepingHistory:I
    ...
    iput v2, v0, Lcom/android/server/am/ActivityStack;->mMotLogSleepingHistory:I
    ...
    iget v5, v0, Lcom/android/server/am/ActivityStack;->mMotLogSleepingHistory:I
...
.method final startActivityLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;[Landroid/net/Uri;ILandroid/content/pm/ActivityInfo;Landroid/os/IBinder;Ljava/lang/String;IIIZZ[Lcom/android/server/am/ActivityRecord;)I
    ...
    const-string v4, "com.motorola.Camera/.Camera"
    ...
    const-string v3, "/sys/module/omap_cpuboost/parameters"
    ...
    .line 2476
    .local v19, BOOST_DIR:Ljava/io/File;
    new-instance v20, Ljava/io/File;

    const-string v3, "cpuboost_time"
    ...
    .line 2477
    .local v20, BOOST_FILE:Ljava/io/File;
    const/16 v24, 0x0

    .line 2479
    .local v24, boost_cpu_writer:Ljava/io/FileWriter;
    new-instance v22, Ljava/io/File;

    const-string v3, "/sys/module/media_cache_mgmt/parameters"
    ...
    .line 2480
    .local v22, MEDIACACHE_DIR:Ljava/io/File;
    new-instance v21, Ljava/io/File;

    const-string v3, "media_cache_mgmt"
    ...
    .line 2481
    .local v21, DROP_FILE:Ljava/io/File;
    const/16 v27, 0x0

    .line 2484
    .local v27, drop_caches_writer:Ljava/io/FileWriter;
    :try_start_0
    ...
    .line 2485
    .end local v24           #boost_cpu_writer:Ljava/io/FileWriter;
    .local v25, boost_cpu_writer:Ljava/io/FileWriter;
    :try_start_1
    ...
    .line 2497
    .end local v25           #boost_cpu_writer:Ljava/io/FileWriter;
    .restart local v24       #boost_cpu_writer:Ljava/io/FileWriter;
    :cond_2
    :goto_1
    :try_start_3
    ...
    .line 2498
    .end local v27           #drop_caches_writer:Ljava/io/FileWriter;
    .local v28, drop_caches_writer:Ljava/io/FileWriter;
    :try_start_4
    const-string v3, "3"
    ...
    .line 2512
    .end local v19           #BOOST_DIR:Ljava/io/File;
    .end local v20           #BOOST_FILE:Ljava/io/File;
    .end local v21           #DROP_FILE:Ljava/io/File;
    .end local v22           #MEDIACACHE_DIR:Ljava/io/File;
    .end local v24           #boost_cpu_writer:Ljava/io/FileWriter;
    .end local v28           #drop_caches_writer:Ljava/io/FileWriter;
    :cond_3
    :goto_2
    if-nez v30, :cond_4
    ...
    .line 2492
    .restart local v19       #BOOST_DIR:Ljava/io/File;
    .restart local v20       #BOOST_FILE:Ljava/io/File;
    .restart local v21       #DROP_FILE:Ljava/io/File;
    .restart local v22       #MEDIACACHE_DIR:Ljava/io/File;
    .restart local v25       #boost_cpu_writer:Ljava/io/FileWriter;
    .restart local v27       #drop_caches_writer:Ljava/io/FileWriter;
    :catch_0
    move-exception v3
    ...
    const-string v4, "Error writing to boost_cpu_time sysfs file"
    ...
    .line 2505
    .end local v27           #drop_caches_writer:Ljava/io/FileWriter;
    .restart local v28       #drop_caches_writer:Ljava/io/FileWriter;
    :catch_3
    move-exception v29
    ...
    const-string v4, "Error writing to media_cache_mgmt sysfs file"
    ...
    const-string v7, "Error writing to media_cache_mgmt sysfs file"
    ...
    .line 2635
    new-instance v34, Lcom/android/server/am/ActivityManagerService$PendingActivityLaunch;

    invoke-direct/range {v34 .. v34}, Lcom/android/server/am/ActivityManagerService$PendingActivityLaunch;-><init>()V

    .line 2636
    .local v34, pal:Lcom/android/server/am/ActivityManagerService$PendingActivityLaunch;
    ...
    .line 2647
    .end local v34           #pal:Lcom/android/server/am/ActivityManagerService$PendingActivityLaunch;
    :cond_18
    move-object/from16 v0, p0
...
.method final startActivityMayWait(Landroid/app/IApplicationThread;ILandroid/content/Intent;Ljava/lang/String;[Landroid/net/Uri;ILandroid/os/IBinder;Ljava/lang/String;IZZLjava/lang/String;Landroid/os/ParcelFileDescriptor;ZLandroid/app/IActivityManager$WaitResult;Landroid/content/res/Configuration;)I
    ...
    invoke-interface {v2, v4, v5}, Landroid/content/pm/IPackageManager;->getActivityInfo(Landroid/content/ComponentName;I)Landroid/content/pm/ActivityInfo;
    ...
    const-string v4, "com.motorola.activity.AnimInLaunchDisabled"
    ...
    invoke-virtual {v2, v4, v5, v6}, Lcom/android/server/wm/WindowManagerService;->overridePendingAppTransition(Ljava/lang/String;II)V
    :try_end_0
    ...
    invoke-direct {v0, v3}, Lcom/android/server/am/ActivityStack;->dispatchScreenStatusLocked(Landroid/content/Intent;)V
