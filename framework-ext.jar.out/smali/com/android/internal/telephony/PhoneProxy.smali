...
.method private handleMessageForCdmaGsmWorldPhone(Landroid/os/Message;)V
    ...
    .line 308
    const-string v3, "switch to CDMAPhone and switch out from the old GSMPhone."
    ...
    invoke-virtual {v3}, Lcom/android/internal/telephony/gsm/GSMPhone;->switchToCdma()V
    ...
    invoke-virtual {v3}, Lcom/android/internal/telephony/cdma/CDMAPhone;->switchToCdma()V

    .line 325
    const-string v3, "persist.radio.ap.phonetype"
    ...
    invoke-virtual {v3}, Lcom/android/internal/telephony/cdma/CDMAPhone;->switchToGsm()V
    ...
    invoke-virtual {v3}, Lcom/android/internal/telephony/gsm/GSMPhone;->switchToGsm()V
...
.method private handleMessageForNewArch(Landroid/os/Message;)V
    ...
    const-string v6, "Error! This handler was not registered for this message type. Message: "
    ...
    iput-object v4, p0, Lcom/android/internal/telephony/PhoneProxy;->mOutgoingPhone:Ljava/lang/String;
    ...
    const-string v5, "Switching phone from "
    ...
    .line 167
    const-string v4, "Setting Radio Power to Off"
    ...
    .line 172
    :cond_0
    iget-object v4, p0, Lcom/android/internal/telephony/PhoneProxy;->mModemConfigManager:Lcom/motorola/android/internal/telephony/ModemConfigManager;

    iget v5, p0, Lcom/android/internal/telephony/PhoneProxy;->mModemId:I

    invoke-virtual {v4, v5}, Lcom/motorola/android/internal/telephony/ModemConfigManager;->getModemInfo(I)Lcom/motorola/android/internal/telephony/ModemConfigManager$ModemInfo;

    move-result-object v1

    .line 174
    .local v1, modem:Lcom/motorola/android/internal/telephony/ModemConfigManager$ModemInfo;
    iget-object v4, p0, Lcom/android/internal/telephony/PhoneProxy;->mOutgoingPhone:Ljava/lang/String;
    ...
    .line 175
    const-string v4, "switch to CDMAPhone and switch out from the old GSMPhone."
    ...
    invoke-virtual {v4}, Lcom/android/internal/telephony/gsm/GSMPhone;->deactivate()V
    ...
    invoke-virtual {v1}, Lcom/motorola/android/internal/telephony/ModemConfigManager$ModemInfo;->getCdmaPhone()Lcom/android/internal/telephony/Phone;
    ...
    .line 189
    const-string v4, "error active phone is null"
    ...
    .line 161
    .end local v1           #modem:Lcom/motorola/android/internal/telephony/ModemConfigManager$ModemInfo;
    .end local v2           #oldPhone:Lcom/android/internal/telephony/Phone;
    .end local v3           #oldPowerState:Z
    :cond_1
    ...
    .line 192
    .restart local v1       #modem:Lcom/motorola/android/internal/telephony/ModemConfigManager$ModemInfo;
    .restart local v2       #oldPhone:Lcom/android/internal/telephony/Phone;
    .restart local v3       #oldPowerState:Z
    :cond_2
    iget-object v4, p0, Lcom/android/internal/telephony/PhoneProxy;->mActivePhone:Lcom/android/internal/telephony/Phone;

    check-cast v4, Lcom/android/internal/telephony/cdma/CDMAPhone;

    invoke-virtual {v4}, Lcom/android/internal/telephony/cdma/CDMAPhone;->activate()V

    .line 208
    :goto_3
    iget-boolean v4, p0, Lcom/android/internal/telephony/PhoneProxy;->mIsCdmaGsmWorldPhone:Z

    if-eqz v4, :cond_3

    iget-boolean v4, p0, Lcom/android/internal/telephony/PhoneProxy;->mIsCdmaSourceFromNV:Z

    if-nez v4, :cond_4

    .line 209
    :cond_3
    iget-object v4, p0, Lcom/android/internal/telephony/PhoneProxy;->mIccCardProxy:Lcom/motorola/android/internal/telephony/IccCardProxy;
    ...
    invoke-virtual {v4, v5}, Lcom/motorola/android/internal/telephony/IccCardProxy;->setActivePhoneType(I)V
    ...
    invoke-virtual {v1, v4}, Lcom/motorola/android/internal/telephony/ModemConfigManager$ModemInfo;->setPhoneTypeInGlobalNetworkMode(I)V
    ...
    .line 215
    const-string v4, "Resetting Radio"
    ...
    invoke-interface {v4, v3, v7}, Lcom/android/internal/telephony/CommandsInterface;->setRadioPower(ZLandroid/os/Message;)V

    .line 220
    :cond_5
    iget-object v4, p0, Lcom/android/internal/telephony/PhoneProxy;->mIccSmsInterfaceManagerProxy:Lcom/android/internal/telephony/IccSmsInterfaceManagerProxy;

    iget-object v5, p0, Lcom/android/internal/telephony/PhoneProxy;->mActivePhone:Lcom/android/internal/telephony/Phone;

    invoke-interface {v5}, Lcom/android/internal/telephony/Phone;->getIccSmsInterfaceManager()Lcom/android/internal/telephony/IccSmsInterfaceManager;

    move-result-object v5

    invoke-virtual {v4, v5}, Lcom/android/internal/telephony/IccSmsInterfaceManagerProxy;->setmIccSmsInterfaceManager(Lcom/android/internal/telephony/IccSmsInterfaceManager;)V
    ...
    .end local v2           #oldPhone:Lcom/android/internal/telephony/Phone;
    :cond_8
    const-string v4, "Make a new GSMPhone and destroy the old CDMAPhone."
    ...
    invoke-virtual {v4}, Lcom/android/internal/telephony/cdma/CDMAPhone;->deactivate()V
    ...
    .line 202
    const-string v4, "error, active phone  gsm is null"
    ...
    invoke-virtual {v4}, Lcom/android/internal/telephony/gsm/GSMPhone;->activate()V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 386
    iget-boolean v3, p0, Lcom/android/internal/telephony/PhoneProxy;->mIsCdmaGsmWorldPhone:Z

    if-eqz v3, :cond_0

    iget-boolean v3, p0, Lcom/android/internal/telephony/PhoneProxy;->mIsNewArch:Z
