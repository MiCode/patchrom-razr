...
.method public constructor <init>(ILcom/android/internal/telephony/PhoneBase;)V
    ...
    .line 360
    iget-object v1, p2, Lcom/android/internal/telephony/PhoneBase;->mIccCard:Lcom/android/internal/telephony/IccCard;
...
.method private activateMe()V
    ...
    .line 281
    iget-object v4, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mIccRecords:Lcom/android/internal/telephony/IccRecords;
    ...
    .line 302
    iget-boolean v4, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mLteOnCdma:Z

    if-eqz v4, :cond_1

    .line 303
    const-string v4, "com.motorola.ims.action.registration_status"
    ...
    .line 310
    new-instance v4, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker$ApnChangeObserver;

    invoke-direct {v4, p0}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker$ApnChangeObserver;-><init>(Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;)V

    iput-object v4, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mApnObserver:Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker$ApnChangeObserver;
    ...
    iget-object v6, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mApnObserver:Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker$ApnChangeObserver;
    ...
    .line 317
    iput-boolean v3, p0, Lcom/android/internal/telephony/DataConnectionTracker;->mAvailability:Z
    ...
    iput-boolean v4, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mIsImsTestMode:Z
    ...
    iput-boolean v4, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mIsCbsAutoApn:Z
    ...
    const-string v5, "dun_apn_changable"
    ...
    :goto_1
    iput-boolean v2, p0, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mDunTraffic:Z
    :try_end_1
...
.method private requestDataSetup(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-virtual {p0, v1, v0}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
.method private setupData(Lcom/android/internal/telephony/ApnContext;)Z
    ...
    invoke-virtual {p0, v7}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->setSetupInProgress(Z)V
    ...
    invoke-virtual {v1, v8, v9}, Lcom/android/internal/telephony/gsm/GsmDataConnection;->setNextInactivityExpiry(J)V
...
.method protected gotoIdleAndNotifyDataConnection(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->setSetupInProgress(Z)V
...
.method protected onDataSetupComplete(Landroid/os/AsyncResult;)V
    ...
    .prologue
    .line 2531
    sget-object v9, Lcom/android/internal/telephony/DataConnection$FailCause;->UNKNOWN:Lcom/android/internal/telephony/DataConnection$FailCause;

    .line 2532
    .local v9, cause:Lcom/android/internal/telephony/DataConnection$FailCause;
    const/4 v14, 0x0
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->setSetupInProgress(Z)V
    ...
    .line 2569
    const-string v27, "onDataSetupComplete: no connection to DC, handle as error"
    ...
    .line 2570
    sget-object v9, Lcom/android/internal/telephony/DataConnection$FailCause;->CONNECTION_TO_DATACONNECTIONAC_BROKEN:Lcom/android/internal/telephony/DataConnection$FailCause;
    ...
    .line 2604
    const-string v27, "onDataSetupComplete: PREFERED APN is null"
    ...
    .line 2614
    const-string v27, "gsm.defaultpdpcontext.active"
    ...
    .line 2650
    .local v19, linkProp:Landroid/net/LinkProperties;
    ...
    invoke-static {v0, v1, v2}, Lcom/motorola/android/internal/util/TelephonyNetworkInterfaceMtuUtils;->setInterfaceMtu(Ljava/lang/String;Lcom/android/internal/telephony/ApnSetting;Landroid/content/Context;)I
    ...
    const-string v29, "FAILED in setting mtu to "
    ...
    .end local v19           #linkProp:Landroid/net/LinkProperties;
    ...
    const-string v28, "onDataSetupComplete: No apnContext"
    ...
    .line 2578
    .local v11, dc:Lcom/android/internal/telephony/DataConnection;
    const-string v7, "<unknown>"

    .line 2579
    .local v7, apnStr:Ljava/lang/String;
    ...
    const-string v28, "onDataSetupComplete: success apn="
    ...
    .line 2591
    .local v21, proxy:Landroid/net/ProxyProperties;
    move-object/from16 v0, v21

    invoke-virtual {v12, v0}, Lcom/android/internal/telephony/DataConnectionAc;->setLinkPropertiesHttpProxySync(Landroid/net/ProxyProperties;)V
    :try_end_0
    ...
    .end local v21           #proxy:Landroid/net/ProxyProperties;
    :catch_0
    move-exception v13
    ...
    const-string v28, "onDataSetupComplete: NumberFormatException making ProxyProperties ("
    ...
    .line 2623
    .end local v7           #apnStr:Ljava/lang/String;
    .end local v11           #dc:Lcom/android/internal/telephony/DataConnection;
    ...
    .line 2634
    .local v26, toSetupDefault:Z
    const-string v27, "persist.radio.lte.ignoreims"
    ...
    const-string v28, "IMSPdnConnected"

    sget v29, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->APN_DELAY_MILLIS:I
    ...
    .line 2634
    .end local v16           #imsRegDisabled:Z
    :cond_9
    const/16 v16, 0x0
    ...
    .line 2663
    .end local v26           #toSetupDefault:Z
    .restart local v17       #interfaceName:Ljava/lang/String;
    .restart local v19       #linkProp:Landroid/net/LinkProperties;
    ...
    invoke-virtual/range {v27 .. v27}, Lcom/android/internal/telephony/PhoneBase;->getServiceState()Landroid/telephony/ServiceState;
    ...
    .line 2668
    .local v25, tearDown:Z
    invoke-virtual/range {v19 .. v19}, Landroid/net/LinkProperties;->getAddresses()Ljava/util/Collection;

    move-result-object v18

    .line 2669
    .local v18, linkAddr:Ljava/util/Collection;,"Ljava/util/Collection<Ljava/net/InetAddress;>;"
    ...
    const-string v28, "default LTE datacall setup with IPV6 only response, tear down"
    ...
    .end local v15           #i$:Ljava/util/Iterator;
    .end local v17           #interfaceName:Ljava/lang/String;
    .end local v18           #linkAddr:Ljava/util/Collection;,"Ljava/util/Collection<Ljava/net/InetAddress;>;"
    .end local v19           #linkProp:Landroid/net/LinkProperties;
    .end local v22           #radioTech:I
    .end local v23           #result:I
    .end local v25           #tearDown:Z
    :cond_d
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v27 .. v28}, Lcom/android/internal/telephony/DataInactivityTracker;->updateInactivityTracking(Ljava/util/Collection;)V
    ...
    const-string v28, "ftr_fdn_notify_enabled"

    const/16 v29, 0x0

    invoke-static/range {v27 .. v29}, Lcom/motorola/android/provider/MotorolaSettings;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    invoke-virtual/range {v27 .. v27}, Lcom/android/internal/telephony/PhoneBase;->getIccCard()Lcom/android/internal/telephony/IccCard;

    move-result-object v27

    invoke-virtual/range {v27 .. v27}, Lcom/android/internal/telephony/IccCard;->getIccFdnEnabled()Z
    ...
    const-string v28, "fdnEnabled"

    invoke-virtual/range {v27 .. v28}, Lcom/android/internal/telephony/PhoneBase;->notifyDataConnection(Ljava/lang/String;)V
    ...
    .line 2743
    const-string v27, "onDataSetupComplete: All APN\'s had permanent failures, stop retrying"
    ...
    .line 2745
    sget-object v27, Lcom/android/internal/telephony/DataConnectionTracker$State;->FAILED:Lcom/android/internal/telephony/DataConnectionTracker$State;
    ...
    check-cast v27, Lcom/android/internal/telephony/DataConnection$FailCause;

    move-object/from16 v9, v27

    check-cast v9, Lcom/android/internal/telephony/DataConnection$FailCause;
    ...
    .line 2703
    .local v8, apnString:Ljava/lang/String;
    :goto_5
    const-string v27, "onDataSetupComplete: error apn=%s cause=%s"
    ...
    .line 2705
    invoke-virtual {v9}, Lcom/android/internal/telephony/DataConnection$FailCause;->isEventLoggable()Z
    ...
    invoke-virtual {v9}, Lcom/android/internal/telephony/DataConnection$FailCause;->ordinal()I
    ...
    .end local v10           #cid:I
    :cond_12
    invoke-virtual {v9}, Lcom/android/internal/telephony/DataConnection$FailCause;->isPermanentFail()Z
    ...
    .line 2715
    :cond_13
    invoke-virtual {v6}, Lcom/android/internal/telephony/ApnContext;->removeNextWaitingApn()V

    .line 2717
    const-string v27, "onDataSetupComplete: WaitingApns.size=%d WaitingApnsPermFailureCountDown=%d"
    ...
    .line 2700
    .end local v8           #apnString:Ljava/lang/String;
    :catch_1
    move-exception v13
    ...
    .restart local v8       #apnString:Ljava/lang/String;
    goto/16 :goto_5
    ...
    :cond_14
    const-string v27, "onDataSetupComplete: Not all permanent failures, retry"
    ...
    check-cast v27, Lcom/android/internal/telephony/DataConnection$CallSetupException;

    invoke-virtual/range {v27 .. v27}, Lcom/android/internal/telephony/DataConnection$CallSetupException;->getRetryOverride()I
    ...
    .line 2759
    const-string v27, "No retry is suggested."
    ...
    invoke-direct {v0, v9, v6, v1}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->startDelayedRetry(Lcom/android/internal/telephony/DataConnection$FailCause;Lcom/android/internal/telephony/ApnContext;I)V

    goto/16 :goto_2

    .line 2765
    .end local v24           #retryOverride:I
    :cond_17
    const-string v27, "onDataSetupComplete: Try next APN"
    ...
    .line 2766
    sget-object v27, Lcom/android/internal/telephony/DataConnectionTracker$State;->SCANNING:Lcom/android/internal/telephony/DataConnectionTracker$State;
...
.method protected onDisconnectDone(ILandroid/os/AsyncResult;)V
    ...
    const-string v3, "onDisconnectDone: EVENT_DISCONNECT_DONE connId="
