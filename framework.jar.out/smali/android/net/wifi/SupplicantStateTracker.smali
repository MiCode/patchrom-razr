...
.field private static final MAX_RETRIES_ON_AUTHENTICATION_FAILURE:I = 0x6
...
.field private mIsEAPAuthFailure:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/net/wifi/WifiStateMachine;Landroid/os/Handler;)V
    ...
    .line 47
    iput-boolean v2, p0, Landroid/net/wifi/SupplicantStateTracker;->mIsEAPAuthFailure:Z
...
.method static synthetic access$002(Landroid/net/wifi/SupplicantStateTracker;Z)Z
    ...
    .prologue
    .line 36
    iput-boolean p1, p0, Landroid/net/wifi/SupplicantStateTracker;->mIsEAPAuthFailure:Z
...
.method private sendSupplicantStateChangedBroadcast(Landroid/net/wifi/SupplicantState;Z)V
    ...
    .line 147
    iget-boolean v1, p0, Landroid/net/wifi/SupplicantStateTracker;->mIsEAPAuthFailure:Z

    if-eqz v1, :cond_0

    .line 148
    const-string v1, "EAPsupplicantError"
    ...
    const-string v3, "EAP Auth fail occured mIsEAPAuthFailure: "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-boolean v3, p0, Landroid/net/wifi/SupplicantStateTracker;->mIsEAPAuthFailure:Z
    ...
    iput-boolean v1, p0, Landroid/net/wifi/SupplicantStateTracker;->mIsEAPAuthFailure:Z
