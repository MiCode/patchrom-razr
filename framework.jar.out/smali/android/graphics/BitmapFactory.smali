...
.method public static decodeByteArray([BIILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    :cond_1
    :try_start_0
    invoke-static {p0, p1, p2}, Lcom/motorola/android/graphics/VectorAsset;->createFromByteArray([BII)Lcom/motorola/android/graphics/VectorAsset;

    move-result-object v0

    .line 430
    .local v0, a:Lcom/motorola/android/graphics/VectorAsset;
    if-eqz v0, :cond_4

    .line 432
    iget v3, p3, Landroid/graphics/BitmapFactory$Options;->inTargetDensity:I
    ...
    .line 434
    .local v2, density:I
    invoke-virtual {v0, v2}, Lcom/motorola/android/graphics/VectorAsset;->getBitmap(I)Landroid/graphics/Bitmap;

    move-result-object v1

    .line 445
    .end local v0           #a:Lcom/motorola/android/graphics/VectorAsset;
    .end local v2           #density:I
    :cond_2
    return-object v1

    .line 432
    .restart local v0       #a:Lcom/motorola/android/graphics/VectorAsset;
    :cond_3
    iget v3, p3, Landroid/graphics/BitmapFactory$Options;->inTargetDensity:I
    :try_end_0
...
.method public static decodeStream(Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v3, p0, v7}, Ljava/io/BufferedInputStream;-><init>(Ljava/io/InputStream;I)V
    ...
    .end local v0           #a:Lcom/motorola/android/graphics/VectorAsset;
    :goto_2
    instance-of v5, p0, Landroid/content/res/AssetManager$AssetInputStream;
    ...
    invoke-static {v5, p1, p2}, Landroid/graphics/BitmapFactory;->nativeDecodeAsset(ILandroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    .line 530
    :cond_6
    invoke-static {p0, v4, p1, p2}, Landroid/graphics/BitmapFactory;->nativeDecodeStream(Ljava/io/InputStream;[BLandroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    .end local p0
    :cond_7
    invoke-static {v1, p1, p2}, Landroid/graphics/BitmapFactory;->finishDecode(Landroid/graphics/Bitmap;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
