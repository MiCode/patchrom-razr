...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;ILandroid/database/DatabaseErrorHandler;)V
    ...
    .line 60
    iput-object v1, p0, Landroid/database/sqlite/SQLiteOpenHelper;->mKey:Ljava/lang/String;
...
.method public declared-synchronized getReadableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    iget-object v3, p0, Landroid/database/sqlite/SQLiteOpenHelper;->mKey:Ljava/lang/String;
    ...
    iget-object v6, p0, Landroid/database/sqlite/SQLiteOpenHelper;->mKey:Ljava/lang/String;

    invoke-static {v2, v3, v4, v5, v6}, Landroid/database/sqlite/SQLiteDatabase;->openDatabaseEnc(Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase$CursorFactory;ILandroid/database/DatabaseErrorHandler;Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
...
.method public declared-synchronized getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 194
    .local v8, version:I
    iget v0, p0, Landroid/database/sqlite/SQLiteOpenHelper;->mNewVersion:I
    ...
    .line 198
    :try_start_4
    invoke-virtual {p0, v6}, Landroid/database/sqlite/SQLiteOpenHelper;->onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .line 213
    :cond_5
    invoke-virtual {p0, v6}, Landroid/database/sqlite/SQLiteOpenHelper;->onOpen(Landroid/database/sqlite/SQLiteDatabase;)V
    :try_end_5
    ...
    :cond_7
    :try_start_9
    iget-object v0, p0, Landroid/database/sqlite/SQLiteOpenHelper;->mKey:Ljava/lang/String;
    ...
    iget-object v4, p0, Landroid/database/sqlite/SQLiteOpenHelper;->mErrorHandler:Landroid/database/DatabaseErrorHandler;

    iget-object v5, p0, Landroid/database/sqlite/SQLiteOpenHelper;->mKey:Ljava/lang/String;

    invoke-virtual/range {v0 .. v5}, Landroid/content/Context;->openOrCreateDatabaseEnc(Ljava/lang/String;ILandroid/database/sqlite/SQLiteDatabase$CursorFactory;Landroid/database/DatabaseErrorHandler;Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-virtual {p0, v6, v8, v0}, Landroid/database/sqlite/SQLiteOpenHelper;->onDowngrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    :try_end_a
    ...
    invoke-virtual {p0, v6, v8, v0}, Landroid/database/sqlite/SQLiteOpenHelper;->onUpgrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    :try_end_f
...
.method public setKey(Ljava/lang/String;)V
    ...
    .prologue
    .line 121
    iput-object p1, p0, Landroid/database/sqlite/SQLiteOpenHelper;->mKey:Ljava/lang/String;
