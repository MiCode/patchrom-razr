...
.method private updateSuggestions()V
    ...
    #getter for: Landroid/widget/TextView;->mText:Ljava/lang/CharSequence;
    invoke-static/range {v23 .. v23}, Landroid/widget/TextView;->access$500(Landroid/widget/TextView;)Ljava/lang/CharSequence;
    ...
    invoke-static/range {v23 .. v23}, Landroid/widget/TextView;->access$3000(Landroid/widget/TextView;)Landroid/text/style/SuggestionRangeSpan;
    ...
    new-instance v24, Landroid/text/style/SuggestionRangeSpan;

    invoke-direct/range {v24 .. v24}, Landroid/text/style/SuggestionRangeSpan;-><init>()V

    #setter for: Landroid/widget/TextView;->mSuggestionRangeSpan:Landroid/text/style/SuggestionRangeSpan;
    invoke-static/range {v23 .. v24}, Landroid/widget/TextView;->access$3002(Landroid/widget/TextView;Landroid/text/style/SuggestionRangeSpan;)Landroid/text/style/SuggestionRangeSpan;
    ...
    invoke-static/range {v24 .. v24}, Landroid/widget/TextView;->access$400(Landroid/widget/TextView;)I

    move-result v24

    invoke-virtual/range {v23 .. v24}, Landroid/text/style/SuggestionRangeSpan;->setBackgroundColor(I)V
    ...
    invoke-virtual/range {v23 .. v23}, Landroid/widget/TextView$SuggestionsPopupWindow$SuggestionAdapter;->notifyDataSetChanged()V
