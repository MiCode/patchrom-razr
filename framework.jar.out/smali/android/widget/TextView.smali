...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 8576
    .local v8, isWTMouseEvent:Z
    const/4 v9, 0x0

    .line 8577
    .local v9, isWTMouseLeftButton:Z
    const/4 v10, 0x0

    .line 8578
    .local v10, isWTMouseRightButton:Z
    ...
    iget v11, v0, Landroid/widget/TextView;->mLastWTButtonState:I

    .line 8593
    .local v11, lastButtonState:I
    move-object/from16 v0, p0
    ...
    .end local v11           #lastButtonState:I
    :cond_2
    ...
    invoke-virtual/range {v17 .. v17}, Landroid/widget/TextView$MouseActionPopupWindow;->isShowing()Z
    ...
    invoke-virtual/range {v17 .. v17}, Landroid/widget/TextView$MouseActionPopupWindow;->updatePosition()V
    ...
    invoke-static/range {v17 .. v18}, Landroid/text/method/MetaKeyKeyListener;->getMetaState(Ljava/lang/CharSequence;I)I
    ...
    .line 8594
    .restart local v11       #lastButtonState:I
    :cond_a
    const/4 v8, 0x0
    ...
    invoke-virtual/range {v17 .. v17}, Landroid/widget/TextView$MouseActionPopupWindow;->hide()V
    ...
    const-class v20, Landroid/text/style/ClickableSpan;

    invoke-interface/range {v17 .. v20}, Landroid/text/Spannable;->getSpans(IILjava/lang/Class;)[Ljava/lang/Object;
    ...
    invoke-virtual/range {v17 .. v17}, Landroid/widget/SpellChecker;->onSelectionChanged()V
    ...
    .end local v16           #touchIsFinished:Z
    :cond_1b
    const/16 v16, 0x0
    ...
    .restart local v16       #touchIsFinished:Z
    :cond_1c
    const/16 v17, 0x0
    ...
    invoke-virtual/range {v17 .. v17}, Landroid/widget/TextView$InsertionPointCursorController;->show()V
