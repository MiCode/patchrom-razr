...
.method static synthetic access$2900(Landroid/app/ActivityThread;Landroid/app/LoadedApk;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method private handleUpdatePackageCompatibilityInfo(Landroid/app/ActivityThread$UpdateCompatibilityData;)V
    ...
    :goto_1
    invoke-virtual {v2, v1}, Landroid/view/WindowManagerImpl;->reportNewConfiguration(Landroid/content/res/Configuration;)V
...
.method private installProvider(Landroid/content/Context;Landroid/content/IContentProvider;Landroid/content/pm/ProviderInfo;ZZ)Landroid/content/IContentProvider;
    ...
    .line 4466
    invoke-direct {p0, v1}, Landroid/app/ActivityThread;->scheduleMakeApplication(Landroid/content/pm/ApplicationInfo;)V
    :try_end_0
...
.method public static main([Ljava/lang/String;)V
    ...
    invoke-interface {v3, v1}, Landroid/view/IWindowManager;->getInitialDisplaySize(Landroid/graphics/Point;)V
    ...
    invoke-static {v4, v5}, Landroid/content/res/CompatibilityInfo;->init(II)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v5, "Exception while initializing CompatibilityInfo"
...
.method final handleConfigurationChanged(Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)V
    ...
    .line 3779
    :cond_1
    iget-object v3, p0, Landroid/app/ActivityThread;->mPendingCompatInfo:Landroid/content/res/CompatibilityInfo;
    ...
    iput-object v3, p0, Landroid/app/ActivityThread;->mPendingCompatInfo:Landroid/content/res/CompatibilityInfo;
