...
.method public constructor <init>(Landroid/webkit/WebView$InvokeListBox;)V
    ...
    invoke-static {v0}, Landroid/webkit/WebView;->access$10100(Landroid/webkit/WebView;)Landroid/content/Context;

    move-result-object v1

    #getter for: Landroid/webkit/WebView$InvokeListBox;->mMultiple:Z
    invoke-static {p1}, Landroid/webkit/WebView$InvokeListBox;->access$10200(Landroid/webkit/WebView$InvokeListBox;)Z
    ...
    invoke-static {p1}, Landroid/webkit/WebView$InvokeListBox;->access$10300(Landroid/webkit/WebView$InvokeListBox;)[Landroid/webkit/WebView$InvokeListBox$Container;
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    #getter for: Landroid/view/View;->mContext:Landroid/content/Context;
    invoke-static {v4}, Landroid/webkit/WebView;->access$10400(Landroid/webkit/WebView;)Landroid/content/Context;
    ...
    #getter for: Landroid/webkit/WebView$InvokeListBox;->mMultiple:Z
    invoke-static {v4}, Landroid/webkit/WebView$InvokeListBox;->access$10200(Landroid/webkit/WebView$InvokeListBox;)Z
