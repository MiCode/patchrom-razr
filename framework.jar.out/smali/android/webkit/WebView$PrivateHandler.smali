...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-virtual {v2}, Landroid/webkit/WebView;->showContextMenu()Z
    ...
    invoke-virtual {v2}, Landroid/webkit/WebView;->inEditingMode()Z
    ...
    invoke-static {v2, v3, v4}, Landroid/webkit/WebView;->access$6300(Landroid/webkit/WebView;II)V
    ...
    invoke-static {v2, v3, v4}, Landroid/webkit/WebView;->access$6400(Landroid/webkit/WebView;II)Z
    ...
    invoke-static {v2, v3}, Landroid/webkit/WebView;->access$6500(Landroid/webkit/WebView;I)V
    ...
    invoke-static {v3}, Landroid/webkit/WebView;->access$6600(Landroid/webkit/WebView;)Landroid/content/Context;
    ...
    #getter for: Landroid/view/View;->mContext:Landroid/content/Context;
    invoke-static {v2}, Landroid/webkit/WebView;->access$6700(Landroid/webkit/WebView;)Landroid/content/Context;
    ...
    invoke-static {v2, v3, v13, v4}, Landroid/webkit/WebView;->access$6800(Landroid/webkit/WebView;ILjava/lang/String;Z)V
    ...
    invoke-static {v2}, Landroid/webkit/WebView;->access$6900(Landroid/webkit/WebView;)Landroid/webkit/WebViewCore$DrawData;
    ...
    #getter for: Landroid/webkit/WebView;->mDelaySetPicture:Landroid/webkit/WebViewCore$DrawData;
    invoke-static {v3}, Landroid/webkit/WebView;->access$6900(Landroid/webkit/WebView;)Landroid/webkit/WebViewCore$DrawData;
    ...
    invoke-static {v2, v3}, Landroid/webkit/WebView;->access$6902(Landroid/webkit/WebView;Landroid/webkit/WebViewCore$DrawData;)Landroid/webkit/WebViewCore$DrawData;
    ...
    invoke-static {v2}, Landroid/webkit/WebView;->access$7000(Landroid/webkit/WebView;)Z
    ...
    invoke-static {v2}, Landroid/webkit/WebView;->access$7100(Landroid/webkit/WebView;)I
    ...
    invoke-static {v2, v3}, Landroid/webkit/WebView;->access$7200(IZ)V
    ...
    invoke-static {v2}, Landroid/webkit/WebView;->access$7800(Landroid/webkit/WebView;)Z
    ...
    invoke-static {v2, v3, v4, v5, v6}, Landroid/webkit/WebView;->access$8100(Landroid/webkit/WebView;IIII)V
    ...
    invoke-static {v3, v2}, Landroid/webkit/WebView;->access$8402(Landroid/webkit/WebView;Z)Z
    ...
    invoke-static {v2}, Landroid/webkit/WebView;->access$8600(Landroid/webkit/WebView;)Landroid/webkit/FindActionModeCallback;
    ...
    invoke-static {v2, v3}, Landroid/webkit/WebView;->access$9602(Landroid/webkit/WebView;I)I
    ...
    invoke-static {v2}, Landroid/webkit/WebView;->access$9800(Landroid/webkit/WebView;)Landroid/webkit/AccessibilityInjector;
    ...
    invoke-static {v2, v0}, Landroid/webkit/WebView;->access$9900(Landroid/webkit/WebView;Ljava/util/ArrayList;)V
    ...
    invoke-static {v2, v3, v4}, Landroid/webkit/WebView;->access$10000(Landroid/webkit/WebView;II)V
