...
.field private static final DESKTOP:I = 0x1
...
.field private static final PHONE:I = 0x0
...
.field private static final TABLET:I = 0x2
...
.method protected constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;ILjava/util/Map;Z)V
    ...
    .line 383
    iput-boolean v5, p0, Landroid/webkit/WebView;->mIsWebtopMode:Z
    ...
    .line 877
    iput-wide v6, p0, Landroid/webkit/WebView;->mLastSublayerScrollTime:J
...
.method static synthetic access$11000(Landroid/webkit/WebView;)Landroid/app/AlertDialog;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$11002(Landroid/webkit/WebView;Landroid/app/AlertDialog;)Landroid/app/AlertDialog;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$11102(Landroid/webkit/WebView;Landroid/os/Message;)Landroid/os/Message;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$6300(Landroid/webkit/WebView;II)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$6400(Landroid/webkit/WebView;II)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$6500(Landroid/webkit/WebView;I)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$6600(Landroid/webkit/WebView;)Landroid/content/Context;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$6800(Landroid/webkit/WebView;ILjava/lang/String;Z)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$6900(Landroid/webkit/WebView;)Landroid/webkit/WebViewCore$DrawData;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$6902(Landroid/webkit/WebView;Landroid/webkit/WebViewCore$DrawData;)Landroid/webkit/WebViewCore$DrawData;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$7200(IZ)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$8600(Landroid/webkit/WebView;)Landroid/webkit/FindActionModeCallback;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$9800(Landroid/webkit/WebView;)Landroid/webkit/AccessibilityInjector;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$9900(Landroid/webkit/WebView;Ljava/util/ArrayList;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method private clearTextEntry()V
    ...
    .prologue
    .line 2506
    invoke-virtual {p0}, Landroid/webkit/WebView;->inEditingMode()Z
...
.method private doShortPress()V
    ...
    :cond_3
    iget-boolean v5, p0, Landroid/webkit/WebView;->mIsWebtopMode:Z
    ...
    invoke-virtual {v5}, Landroid/webkit/ZoomManager;->invokeZoomPicker()V
...
.method private drawCoreAndCursorRing(Landroid/graphics/Canvas;IZ)V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/webkit/WebView;->inEditingMode()Z
...
.method private handleTouchEventCommon(Landroid/view/MotionEvent;III)Z
    ...
    iget-boolean v3, v0, Landroid/webkit/WebView;->mIsWebtopMode:Z
    ...
    const-string v5, "Pausing picture updates, IsScrollerFinished:"
    ...
    iget-object v5, v0, Landroid/webkit/WebView;->mScroller:Landroid/widget/OverScroller;
    ...
    const-string v5, ", IsSelectingText:"
    ...
    iget-boolean v5, v0, Landroid/webkit/WebView;->mSelectingText:Z

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v4

    const-string v5, ", Touch Mode:"
...
.method private onActionScroll(Landroid/view/MotionEvent;II)Z
    ...
    .line 6939
    .local v3, contentY:I
    iget-object v8, p0, Landroid/webkit/WebView;->mScrollingLayerRect:Landroid/graphics/Rect;

    iget-object v9, p0, Landroid/webkit/WebView;->mScrollingLayerBounds:Landroid/graphics/Rect;

    invoke-direct {p0, v2, v3, v8, v9}, Landroid/webkit/WebView;->nativeScrollableLayer(IILandroid/graphics/Rect;Landroid/graphics/Rect;)I

    move-result v8

    iput v8, p0, Landroid/webkit/WebView;->mCurrentScrollingLayerId:I

    .line 6943
    iget-object v8, p0, Landroid/webkit/WebView;->mScrollingLayerBounds:Landroid/graphics/Rect;
    ...
    .line 6947
    .local v5, maxPaceY:I
    iget v8, p0, Landroid/webkit/WebView;->mCurrentScrollingLayerId:I
    ...
    .line 6949
    invoke-direct {p0, p3}, Landroid/webkit/WebView;->viewToContentDimension(I)I
    ...
    invoke-static {v8}, Landroid/webkit/WebViewCore;->pauseUpdatePicture(Landroid/webkit/WebViewCore;)V

    .line 6985
    const/4 v8, 0x1

    invoke-direct {p0, v8}, Landroid/webkit/WebView;->nativeSetIsScrolling(Z)V

    .line 6987
    invoke-direct {p0, v6, v7}, Landroid/webkit/WebView;->scrollLayerTo(II)V
    ...
    invoke-static {v8}, Landroid/webkit/WebViewCore;->resumeUpdatePicture(Landroid/webkit/WebViewCore;)V
    ...
    iput-wide v8, p0, Landroid/webkit/WebView;->mLastSublayerScrollTime:J
    ...
    iget-wide v10, p0, Landroid/webkit/WebView;->mLastSublayerScrollTime:J
...
.method private stopTouch()V
    ...
    const-string v2, "Resume picture updates, IsScrollerFinished:"
    ...
    const-string v2, ", IsSelectingText:"
...
.method public onGenericMotionEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_4
    :goto_3
    invoke-virtual {p0}, Landroid/webkit/WebView;->isWebtopMode()Z

    move-result v5

    if-eqz v5, :cond_5

    invoke-direct {p0, p1, v0, v2}, Landroid/webkit/WebView;->onActionScroll(Landroid/view/MotionEvent;II)Z
    ...
    .line 7044
    :cond_5
    invoke-direct {p0, v0, v2, v8, v8}, Landroid/webkit/WebView;->pinScrollBy(IIZI)Z
...
.method rebuildWebTextView()V
    ...
    .line 4983
    :cond_6
    invoke-direct {p0}, Landroid/webkit/WebView;->clearMetaStateIndicator()V
...
.method selectText(II)Z
    ...
    .line 4480
    iget-boolean v0, p0, Landroid/webkit/WebView;->mIsWebtopMode:Z
    ...
    :goto_0
    invoke-direct {p0, v0, p1, p2}, Landroid/webkit/WebView;->setUpSelect(ZII)Z
...
.method public setWebtopMode(Z)V
    ...
    .prologue
    .line 2573
    iput-boolean p1, p0, Landroid/webkit/WebView;->mIsWebtopMode:Z
    ...
    :goto_0
    invoke-virtual {v0, v1}, Landroid/webkit/WebSettings;->setDeviceMode(I)V
