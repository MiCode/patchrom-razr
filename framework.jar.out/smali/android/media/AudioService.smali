...
.field private static final CALL_FOCUS_RELEASE_TIMEOUT_MILLIS:I = 0xbb8
...
.field private static final MOT_LD2_PREM_USB_ID:Ljava/lang/String; = "22b8:6721"

.field private static final MOT_LD2_STD_USB_ID:Ljava/lang/String; = "22b8:6720"

.field private static final MSG_BTA2DP_DOCK_TIMEOUT:I = 0x8

.field private static final MSG_BT_HEADSET_CNCT_FAILED:I = 0xc

.field private static final MSG_CALL_FOCUS_RELEASE_TIMEOUT:I = 0x12
...
.field private static final MSG_USB_AUDIO_POLL_TICKTOCK:I = 0xf
...
.field private static final USB_AUDIO_POLL_TICKTOCK_MILLIS:I = 0x7d0

.field private static final mAudioFocusLock:Ljava/lang/Object;

.field private static mLastUsbMicNum:I

.field private static mLastUsbSpeakerNum:I

.field private static mMotLdCardNum:I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 283
    iput-boolean v7, p0, Landroid/media/AudioService;->mFMRadioRuning:Z
    ...
    iput-object v4, p0, Landroid/media/AudioService;->mConnectedDevices:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 3186
    new-instance v4, Landroid/media/AudioService$4;

    invoke-direct {v4, p0}, Landroid/media/AudioService$4;-><init>(Landroid/media/AudioService;)V
    ...
    iput v4, p0, Landroid/media/AudioService;->mArtworkExpectedWidth:I

    .line 4113
    const/4 v4, -0x1

    iput v4, p0, Landroid/media/AudioService;->mArtworkExpectedHeight:I
    ...
    .line 394
    .local v1, mediaVolumeWarningThreshold:I
    if-lt v1, v10, :cond_0
    ...
    .line 401
    :cond_0
    const-string v4, "ro.config.sound_fx_volume"
    ...
    .line 407
    iput v7, p0, Landroid/media/AudioService;->mForcedUseForMedia:I

    .line 411
    iput v7, p0, Landroid/media/AudioService;->mDockState:I

    .line 415
    sput v7, Landroid/media/AudioService;->mMotLdCardNum:I

    .line 416
    sput v7, Landroid/media/AudioService;->mLastUsbSpeakerNum:I

    .line 417
    sput v7, Landroid/media/AudioService;->mLastUsbMicNum:I
    ...
    .line 443
    const-string v4, "com.motorola.internal.intent.action.MOT_DOCK_EVENT"

    invoke-virtual {v0, v4}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 446
    const-string v4, "com.motorola.internal.intent.action.MEDIA_SPEAKER_ENABLE"
    ...
    .line 454
    const-string v4, "android.intent.action.SEMU_ANLG_AUDIO_PLUG"

    invoke-virtual {v0, v4}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 455
    const-string v4, "android.intent.action.SEMU_SPDIF_AUDIO_PLUG"
    ...
    .line 461
    const-string v4, "com.motorola.fmradio.state"
    ...
    const-string v5, "ro.mot.fid.30544.tty"
...
.method static synthetic access$3802(Landroid/media/AudioService;Lmiui/view/VolumePanel;)Lmiui/view/VolumePanel;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$3900(Landroid/media/AudioService;)Landroid/content/Context;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$5900(Landroid/media/AudioService;)V
    ...
    .prologue
    .line 97
    invoke-direct {p0}, Landroid/media/AudioService;->updateUSB()V
...
.method static synthetic access$6402(I)I
    ...
    .prologue
    .line 97
    sput p0, Landroid/media/AudioService;->mMotLdCardNum:I
...
.method static synthetic access$7000(Landroid/media/AudioService;Z)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 97
    invoke-direct {p0, p1}, Landroid/media/AudioService;->updateSpeakerRouting(Z)V
...
.method private containsLapdockId(Ljava/lang/String;)Z
    .locals 7
    .parameter "pathName"
...
.method private handleFocusForCalls(IILandroid/os/IBinder;)V
    ...
    invoke-virtual {v0, v2}, Landroid/media/AudioService$AudioHandler;->obtainMessage(I)Landroid/os/Message;
    ...
    invoke-virtual {v0, v7, v1, v2}, Landroid/media/AudioService$AudioHandler;->sendMessageDelayed(Landroid/os/Message;J)Z
...
.method private updateSpeakerRouting(Z)V
    .locals 3
    .parameter "enabled"
    ...
    const-string v1, "com.motorola.internal.intent.action.MEDIA_SPEAKER_STATE_CHANGE"
    ...
    .line 2760
    .end local v0           #update:Landroid/content/Intent;
    :cond_0
...
.method private declared-synchronized updateUSB()V
    .locals 17
    ...
    iget v13, v0, Landroid/media/AudioService;->mDockState:I
    ...
    invoke-direct {v4, v0}, Landroid/media/AudioService$3;-><init>(Landroid/media/AudioService;)V

    .line 2036
    .local v4, cardsFilter:Ljava/io/FilenameFilter;
    sget v7, Landroid/media/AudioService;->mMotLdCardNum:I
    ...
    invoke-direct {v0, v13}, Landroid/media/AudioService;->containsLapdockId(Ljava/lang/String;)Z
    ...
    .line 2060
    .local v12, speakerFile:Ljava/io/File;
    ...
    .line 2062
    .local v10, micFile:Ljava/io/File;
    ...
    .end local v6           #i:I
    .end local v10           #micFile:Ljava/io/File;
    .end local v12           #speakerFile:Ljava/io/File;
    :cond_4
    sget v13, Landroid/media/AudioService;->mLastUsbSpeakerNum:I
    ...
    iget-object v14, v0, Landroid/media/AudioService;->mConnectedDevices:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {v13}, Landroid/media/AudioSystem;->setParameters(Ljava/lang/String;)I
    ...
    iget-object v13, v0, Landroid/media/AudioService;->mConnectedDevices:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual {v13, v15}, Ljava/util/concurrent/ConcurrentHashMap;->containsKey(Ljava/lang/Object;)Z
    ...
    invoke-static {v13, v15, v0}, Landroid/media/AudioSystem;->setDeviceConnectionState(IILjava/lang/String;)I
    ...
    invoke-virtual {v13, v15, v0}, Ljava/util/concurrent/ConcurrentHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 2081
    :cond_6
    :goto_3
    sput v9, Landroid/media/AudioService;->mLastUsbSpeakerNum:I
    ...
    :cond_7
    :try_start_4
    sget v13, Landroid/media/AudioService;->mLastUsbMicNum:I
    ...
    :cond_9
    :goto_4
    sput v8, Landroid/media/AudioService;->mLastUsbMicNum:I
    ...
    :cond_a
    :try_start_6
    sget v13, Landroid/media/AudioService;->mMotLdCardNum:I
    ...
    invoke-virtual {v13, v14}, Landroid/media/AudioService$AudioHandler;->obtainMessage(I)Landroid/os/Message;
    ...
    invoke-virtual {v13, v11, v14, v15}, Landroid/media/AudioService$AudioHandler;->sendMessageDelayed(Landroid/os/Message;J)Z
    :try_end_8
...
.method public adjustStreamVolume(III)V
    ...
    iget-boolean v5, v0, Landroid/media/AudioService;->mFMRadioRuning:Z
    ...
    const-string v5, "com.motorola.fmradio.volume.change"
