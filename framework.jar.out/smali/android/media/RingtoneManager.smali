...
.method private getDrmRingtones()Landroid/database/Cursor;
    ...
    invoke-static {v3, v10}, Landroid/media/RingtoneManager;->constructBooleanTrueWhereClause(Ljava/util/List;Z)Ljava/lang/String;
    ...
    .line 533
    .local v7, externalDrmCursor:Landroid/database/Cursor;
    :goto_0
    sget-object v2, Landroid/provider/DrmStore$Audio;->CONTENT_URI:Landroid/net/Uri;

    sget-object v3, Landroid/media/RingtoneManager;->DRM_COLUMNS:[Ljava/lang/String;
    ...
    .line 537
    .local v8, internalDrmCursor:Landroid/database/Cursor;
    new-instance v0, Lcom/android/internal/database/SortCursor;
    ...
    .end local v7           #externalDrmCursor:Landroid/database/Cursor;
    .end local v8           #internalDrmCursor:Landroid/database/Cursor;
    :cond_1
    move-object v7, v4
...
.method private static getRingtone(Landroid/content/Context;Landroid/net/Uri;I)Landroid/media/Ringtone;
    ...
    .line 687
    :cond_3
    invoke-virtual {v3, v1}, Landroid/media/Ringtone;->open(Landroid/net/Uri;)V
    :try_end_1
    ...
    const-string v7, "Failed to open default ringtone "
    ...
    .line 704
    :cond_4
    invoke-virtual {v3, v0}, Landroid/media/Ringtone;->open(Landroid/content/res/AssetFileDescriptor;)V
    ...
    const-string v6, "Failed to open fallback ringtone"
